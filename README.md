...
The dataset has been pruned from this repository due to GitHub file size restraints, and [can be found here](https://www.kaggle.com/datasets/salikhussaini49/prediction-of-sepsis) instead.



While this project constituted 43 commits originally, those could not preserved in the transfer from GitLab because GitHub does not support the large files of the dataset that were part of many of those commits. This commit history can instead be viewed by the curious at [the original host location](https://gitlab.com/JackAuty/comp3931-individual-project/-/commits/master?ref\_type=HEADS).
